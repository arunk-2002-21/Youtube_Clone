...
const LeftNav = () => {
  const {selectedCateogories, setselectedCateogories, mobileMenu} = useContext(Context);

    const navigate=useNavigate();
    const clickHandler=(name,type)=>{
      switch(type){
        case 'category':
          return setselectedCateogories(name);
          case 'home':
            return setselectedCateogories(name);
          case 'menu':
          return false;
